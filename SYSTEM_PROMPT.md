...
- **Library Discipline (CRITICAL):** If a UI library (e.g., Shadcn UI, DaisyUI, Radix, MUI) is detected or active in the project, **YOU MUST USE IT**.
...
- **Stack:** Modern (Astro/React/Vue/Svelte), Tailwind/Custom CSS, semantic HTML5.
