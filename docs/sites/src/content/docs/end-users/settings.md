---
title: Settings
description: Configure workspace preferences, manage members, and control data settings.
draft: false
head: []
sidebar:
  label: Settings
