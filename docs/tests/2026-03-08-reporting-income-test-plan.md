...
```bash
bun test src/db/index.integration.test.ts src/pages/api/categories/index.test.ts src/pages/api/categories/[id].test.ts
...
bun test src/pages/api/reports/index.test.ts src/pages/api/reports/expenses/index.test.ts src/pages/api/reports/income/index.test.ts src/pages/api/reports/category-drilldown.test.ts tests/integration/api/reports/openapi-contract.test.ts
bun run lint:fix
...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Schema + category APIs  | `bun test src/db/index.integration.test.ts src/pages/api/categories/index.test.ts src/pages/api/categories/[id].test.ts`                                                                                                                       | `src/db/index.integration.test.ts`, `src/pages/api/categories/*.test.ts`                                                                                |
...
| Report endpoints        | `bun test src/pages/api/reports/index.test.ts src/pages/api/reports/expenses/index.test.ts src/pages/api/reports/income/index.test.ts src/pages/api/reports/category-drilldown.test.ts tests/integration/api/reports/openapi-contract.test.ts` | `src/pages/api/reports/*.test.ts`, `tests/integration/api/reports/openapi-contract.test.ts`                                                             |
