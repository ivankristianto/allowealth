...
| 1.4  | Open these routes: `/getting-started/`, `/core-concepts/`, `/end-users/onboarding/`, `/end-users/daily-workflow/`, `/admins/onboarding/`, `/admins/deployment-guide/`, `/developers/setup-and-deployment/`, `/developers/feature-workflow/`, `/reference/commands/`, `/reference/cli/`, `/reference/api-overview/`, `/reference/architecture/`, `/changelog/`. | Each route loads without 404 and displays the expected page title.                                                           |
...
| Step | Action                                                                                                                                                                                                                                                                                                                                                                                     | Expected Result                                       |
| ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------- |
| 2.1  | Run `find docs/sites/src/content/docs -name "*.md" \| wc -l`.                                                                                                                                                                                                                                                                                                                              | Output is exactly `14`.                               |
| 2.2  | Verify files present: `index.md`, `getting-started.md`, `core-concepts.md`, `changelog.md`, `end-users/onboarding.md`, `end-users/daily-workflow.md`, `admins/onboarding.md`, `admins/deployment-guide.md`, `developers/setup-and-deployment.md`, `developers/feature-workflow.md`, `reference/commands.md`, `reference/cli.md`, `reference/api-overview.md`, `reference/architecture.md`. | All 14 files exist.                                   |
