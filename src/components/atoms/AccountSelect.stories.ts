...
const mockAccounts = [
  { id: 'account-1', name: 'BCA Savings', type: 'bank_account' },
  { id: 'account-2', name: 'Cash Wallet', type: 'other' },
  { id: 'account-3', name: 'Mandiri Checking', type: 'bank_account' },
];

const createAccountSelect = (args: {
  label?: string;
  helpText?: string;
  value?: string;
  required?: boolean;
  ...
  const inputId = `account-select-${Math.random().toString(36).slice(2, 9)}`;
...
export const Default: StoryObj = {
  render: (args) => createAccountSelect(args),
};

export const WithValue: StoryObj = {
  args: { value: 'account-2' },
  render: (args) => createAccountSelect(args),
};
...
export const Disabled: StoryObj = {
  args: { disabled: true, value: 'account-1' },
  render: (args) => createAccountSelect(args),
};
