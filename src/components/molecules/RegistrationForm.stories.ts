...
const createRegistrationForm = (args: {
  ...
  // Name field
  const nameControl = createFormField(
    'name',
    'text',
    'Full Name',
  ...
  // Email field
  const emailControl = createFormField(
    'email',
    'email',
    'Email Address',
  ...
  const passwordControl = createPasswordFieldWithStrength(
    'password',
    'password',
    'Password',
  ...
  const confirmControl = createFormField(
    'confirm-password',
    'password',
    'Confirm Password',
...
export const WithValidation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Form with client-side validation enabled. Try submitting with invalid data to see error messages.',
      },
    },
  },
};
...
export const PasswordValidation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The password field includes real-time strength validation with a visual meter and requirements checklist.',
      },
    },
  },
};
...
export const EmailValidation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Email field validates format on submission. Invalid email addresses will show an error message.',
      },
    },
  },
};
...
export const PasswordMismatch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'If the password and confirm password fields do not match, an error message is displayed on submission.',
      },
    },
  },
};
