...
const defaultData: SpendingCategory[] = [
...
const highSpendingData: SpendingCategory[] = [...defaultData];
const lowSpendingData: SpendingCategory[] = [
...
const createSpendingChart = (args: {
...
export const Default: StoryObj = {
  ...
  render: (args) => createSpendingChart({ ...args, data: defaultData }),
};
...
export const HighSpending: StoryObj = {
  ...
  render: (args) => createSpendingChart({ ...args, data: highSpendingData }),
};

export const LowSpending: StoryObj = {
  args: {
    totalSpent: 35000000,
    totalBudget: 65900000,
    loading: false,
  ...
  render: (args) => createSpendingChart({ ...args, data: lowSpendingData }),
};
...
export const FewCategories: StoryObj = {
  ...
  render: (args) => createSpendingChart({ ...args, data: fewCategoriesData }),
};
...
export const ManyCategories: StoryObj = {
  ...
  render: (args) => createSpendingChart({ ...args, data: manyCategoriesData }),
};
...
export const Empty: StoryObj = {
  ...
  render: (args) => createSpendingChart({ ...args, data: [] }),
};
