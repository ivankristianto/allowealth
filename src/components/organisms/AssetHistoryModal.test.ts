/**
 * AssetHistoryModal Component Tests
 * ==================================
 * Tests for AssetHistoryModal component chart logic and data handling
 */
...
describe('AssetHistoryModal - Change Calculation', () => {
...
describe('AssetHistoryModal - History Filtering', () => {
...
describe('AssetHistoryModal - Mock History Generation', () => {
...
describe('AssetHistoryModal - Chart Data', () => {
...
describe('AssetHistoryModal - Timeframe Toggle', () => {
...
describe('AssetHistoryModal - Display Formatting', () => {
  describe('Asset Meta Display', () => {
    it('should format meta text correctly', () => {
      const type = 'Bank Account';
      const currency = 'IDR';
      const meta = `${type} • ${currency} Portfolio`;
      expect(meta).toBe('Bank Account • IDR Portfolio');
    });
  });
...
describe('AssetHistoryModal - Accessibility', () => {
  describe('Modal Structure', () => {
    it('should have asset name as heading', () => {
      const asset = { name: 'BCA Checking' };
      expect(asset.name).toBe('BCA Checking');
    });
...
describe('AssetHistoryModal - Events', () => {
  describe('Custom Events', () => {
    it('should listen for open-asset-history event', () => {
      const eventName = 'open-asset-history';
      expect(eventName).toBe('open-asset-history');
    });

    it('should receive asset data in event detail', () => {
      const detail: AssetHistoryData = {
        id: 'abc-123',
        name: 'BCA Checking',
        type: 'Bank Account',
        currency: 'IDR',
