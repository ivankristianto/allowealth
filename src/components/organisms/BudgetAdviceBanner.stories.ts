...
const createBudgetAdviceBanner = (args: {
  title?: string;
  categoryName?: string;
  ...
  const dismissBtn = container.querySelector('[data-dismiss-advice]');
  if (dismissBtn) {
    dismissBtn.addEventListener('click', () => {
      const banner = container.querySelector('[data-advice-banner]');
      if (banner) {
...
export const Default: StoryObj = {
  ...
  render: (args) => createBudgetAdviceBanner(args),
};

export const ExceededWarning: StoryObj = {
  args: {
    title: 'Budget Alert',
    categoryName: 'Dining',
    status: 'exceeded',
...
export const SavingsOpportunity: StoryObj = {
  args: {
