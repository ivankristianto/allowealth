#!/bin/bash
# Create Smart Scan Receipt GitHub Issue
...
**Dependencies**: Anthropic API access, image upload infrastructure
EOF
)

echo "Creating GitHub issue..."
gh issue create \
  --title "Smart Scan Receipt - AI-Powered Receipt Scanning Feature" \
  --label "enhancement" \
  --body "$ISSUE_BODY"
