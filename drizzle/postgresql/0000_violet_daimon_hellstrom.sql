...
ALTER TABLE "assets" ADD CONSTRAINT "assets_closed_by_user_id_users_id_fk" FOREIGN KEY ("closed_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "asset_history_asset_recorded_idx" ON "asset_history" USING btree ("asset_id","recorded_at");--> statement-breakpoint
